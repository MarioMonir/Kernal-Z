...
slidesImages.map((slide) => {
    ...
    data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/slider/${slide.slideImg}"
    data-rotate="0" data-saveperformance="off" data-title="Construction Services" data-description="">
    <!-- MAIN IMAGE -->
    <img src="images/slider/${slide.slideImg}" alt="#" data-bgposition="center center" data-kenburns="on"
    ...
    <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-18-layer-112"
      ...
      style="z-index: 6; white-space: nowrap;">Construction Services </div>
    <!-- LAYER NR. 3 -->
